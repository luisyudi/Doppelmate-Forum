...
<body>
    ...
    <div id="content" style="min-height: 800px;">
        <p style="text-align: center; color: white; font-size: 200px; margin: 150px 0 0 0;">404</p>
        <p style="color: white; text-align: center; font-size: 30px">Página não encontrada</p>
    </div>
    <div id="footer">
